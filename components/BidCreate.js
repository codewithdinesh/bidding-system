...
export default function CreateBid() {
    ...
    return (
        <div className="max-w-md mx-auto e flex-1  ">

            <div className='border border-slate-200 shadow-md rounded-lg p-4 bg-white'>

                <h1 className="text-2xl font-bold mb-4">Create New Bid</h1>
                {error && <p className="text-red-500 mb-4">{error}</p>}
                <form onSubmit={handleSubmit} className="space-y-4 max-h-fit">
                    <div>
